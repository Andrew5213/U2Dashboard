...
class EmailService:
    ...
    async def send_weekly_report(self, space_id: str) -> None:
        ...
        msg["Subject"] = f"Weekly Progress Report — U2 Broadcast — W{week_num:02d}/{year}"
...
<head>
  ...
  <title>Weekly Progress Report — U2 Broadcast</title>
</head>
    ...
    <tr>
      <td style="background:#1B3A6B;padding:32px 40px 28px;">
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td>
              <p style="margin:0 0 6px;color:#93c5fd;font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;">U2 Broadcast</p>
    ...
    <tr>
      <td style="padding:36px 40px 28px;">
        ...
        <p style="margin:0 0 20px;color:#334155;font-size:14px;line-height:1.7;">
          Please find attached the weekly progress report for the U2 Broadcast installation programme,
          ...
          <tr>
            <td>
              <p style="margin:0;color:#94a3b8;font-size:11px;line-height:1.6;">
                This is an automated message generated by the U2 Broadcast<br>
