...
STRINGS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "prov_updates_subtitle": "Periodo: {period}  ·  {concluded} concluidas · {updated} atualizadas",
        ...
        "filename_discipline": "relatorio_disciplina_{ts}.pdf",
        # ── Relatório por Disciplina ─────────────────────────────────────────
        "disc_report_eyebrow": "U2 BROADCAST - RELATORIO DE DISCIPLINA",
        "disc_report_meta": "{n} atividade(s)  ·  Gerado em {date} - Atraves do sistema U2 Dashboard",
        "disc_no_activities": "Nenhuma atividade encontrada para esta disciplina.",
        "disc_footnote": (
            "Documento gerado automaticamente pelo sistema de gestao de projetos U2 Broadcast em {date}."
        ),
        "disc_note_label": "Observacao",
        "list_report_meta": "{d} disciplina(s)  ·  {n} atividade(s)  ·  Gerado em {date} - Atraves do sistema U2 Dashboard",
        "filename_list": "relatorio_lista_{ts}.pdf",
    ...
    "en": {
        ...
        "prov_updates_subtitle": "Period: {period}  ·  {concluded} completed · {updated} updated",
        ...
        "filename_discipline": "discipline_report_{ts}.pdf",
        # ── Discipline Report ─────────────────────────────────────────────────
        "disc_report_eyebrow": "U2 BROADCAST - DISCIPLINE REPORT",
        "disc_report_meta": "{n} activity(ies)  ·  Generated on {date} - Via U2 Dashboard system",
        "disc_no_activities": "No activities found for this discipline.",
        "disc_footnote": (
            "Document automatically generated by the U2 Broadcast project management system on {date}."
        ),
        "disc_note_label": "Note",
        "list_report_meta": "{d} discipline(s)  ·  {n} activity(ies)  ·  Generated on {date} - Via U2 Dashboard system",
        "filename_list": "list_report_{ts}.pdf",
        "no_status": "No status",
    },
}
