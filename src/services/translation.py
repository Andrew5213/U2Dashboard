...
_EN: dict[str, str] = {
    ...
    # ── Disciplinas — variantes/nomes curtos encontrados ao vivo na API ───────
    "obra civil":                                    "Civil Works",
    "equipamentos":                                  "Equipment",
    "mobiliario":                                    "Furniture",
    "instalacao acustica":                           "Acoustic Installation",
    "sat accepting tests":                           "SAT Acceptance Tests",
    "civil works":                                   "Civil Works",
    "end of work":                                   "End of Work",
    "pre commissioning tests":                       "Pre-Commissioning Tests",
    "studio accoustic furniture installation":       "Studio Acoustic Furniture Installation",
    "studio equipment installation":                 "Studio Equipment Installation",
    "studio furniture installation":                 "Studio Furniture Installation",
    ...
    # Newsroom / Redação & Studio (variantes curtas encontradas ao vivo na API)
    "acabamento de pintura":                         "Paint Finishing",
    "cabeamento maquina playlist":                   "Playlist Machine Cabling",
    "configuracoes de equipamentos":                 "Equipment Configuration",
    "crimpagem de cabos de rede":                    "Network Cable Crimping",
    "elaborar termo de encerramento":                "Prepare Closure Term",
    "etiquetagem de cabos":                          "Cable Labeling",
    "instacao rede de ar condicionado":              "Air Conditioning Duct Installation",
    "instalacao rede dos ar condicionados":          "Air Conditioning Duct Installation",
    "instalacao blades":                             "Blade Installation",
    "instalacao de blades":                           "Blade Installation",
    "instalacao caixas de som hs5":                  "HS5 Speaker Installation",
    "instalacao de aquarios":                        "Studio Window (Aquarium) Installation",
    "instalacao de audio":                           "Audio Installation",
    "instalacao de calhas":                          "Cable Trunking Installation",
    "instalacao de ciscos":                          "Cisco Equipment Installation",
    "instalacao de computadores":                    "Computer Installation",
    "instalacao de hacks":                           "Hacks Installation",
    "instalacao de marshall":                        "Marshall Installation",
    "instalacao de mesas":                           "Table Installation",
    "instalacao de patch de audio":                  "Audio Patch Panel Installation",
    "instalacao de pisos":                           "Flooring Installation",
    "instalacao de rede":                            "Network Installation",
    "instalacao de relogio":                         "Clock Installation",
    "instalacao de ripado":                          "Batten Installation",
    "instalacao de servidores":                      "Server Installation",
    "instalacao de suporte de nuvens acusticas":     "Acoustic Cloud Support Installation",
    "instalacao de ups":                             "UPS Installation",
    "instalacao deva":                               "DEVA Installation",
    "instalacao do lxe 2112t e ps1300":               "LXE-2112T & PS1300 Installation",
    "instalacao eletrica":                           "Electrical Installation",
    "instalacao eletrica 110v":                      "110V Electrical Installation",
    "instalacao eletrica 220v":                      "220V Electrical Installation",
    "instalacao moveis":                             "Furniture Installation",
    "instalacao notabot":                            "NotaBot Installation",
    "instalacao on air":                              "On Air Installation",
    "instalacao pedestais suporte microfones re320": "RE320 Mic Stands & Supports Installation",
    "instalacao playlist":                           "Playlist Installation",
    "instalacao playlist wheatstone audacity":       "Playlist / Wheatstone / Audacity Installation",
    "integracao studios na ctp":                     "Studio Integration at CTP",
    "ligacao de estudio":                            "Studio Connection",
    "ligacao de redacao":                            "Newsroom Connection",
    "limpeza da area":                               "Area Cleaning",
    "massa e pintura":                               "Filler & Painting",
    "passagem de cabos de audio":                    "Audio Cable Routing",
    "passagem de cabos de rede":                     "Network Cable Routing",
    "pisos acusticos":                               "Acoustic Flooring",
    "remocao e demolicao":                           "Removal & Demolition",
    "soldagem de cabos de audio":                    "Audio Cable Soldering",
    "tetos e paredes drywall":                        "Ceilings & Walls - Drywall",
    ...
    "noc":               "NOC",
    "ctp":               "CTP",
    "estudio ct2":       "Studio CT2",
    "estudio ct3":       "Studio CT3",
    "estudio ct4":       "Studio CT4",
    "estudio ct5b":      "Studio CT5B",
    "estudio ct6a":      "Studio CT6A",
    "estudio ct7":       "Studio CT7",
    "estudio ct8a":      "Studio CT8A",
    "estudio ct8b":      "Studio CT8B",
    "estudio ct9a":      "Studio CT9A",
    "estudio ct9b":      "Studio CT9B",
    "estudio ct11a":     "Studio CT11A",
    "estudio ct12":      "Studio CT12",
    "redacao canal a":              "Newsroom - Canal A",
    "redacao ngola yeto":           "Newsroom - Ngola' Yeto",
    "redacao radio internacional":  "Newsroom - Rádio Internacional",
    "redacao radio luanda":         "Newsroom - Rádio Luanda",
    "redacao radio 5":              "Newsroom - Rádio 5",
